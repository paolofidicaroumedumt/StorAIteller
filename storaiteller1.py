...
async def redopartstory(parts: Storyparts):
    try:
        ...
        global currentprompt
        print ("redo")
        newprompt = currentprompt + "It is important that the story starts with this part unchanged: '" + parts.textbefore + "' and finishes with this part unchanged: '" + parts.textafter + "'"
        print (newprompt)
